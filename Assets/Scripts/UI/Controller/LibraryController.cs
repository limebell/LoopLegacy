...
public class LibraryController : MonoBehaviour
{
    ...
    public void Show()
    {
        ...
        _effectLabelText.text =
            ...
            $"{Utils.GetUIString("library_stat-multiplier-by-accumulated-level")}\n" +
        ...
        _effectValueText.text =
            ...
            $"{Mathf.RoundToInt(LibraryManager.GetStatMultiplier(PersistentGameState.Instance.AccumulatedLevel) * 100 - 100)}%\n" +
